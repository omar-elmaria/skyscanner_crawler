...
crawling_date = datetime.now().date() + timedelta(days=7) + timedelta(days=365)
...
extract_flight_data_by_date(
    ...
    flight_data_json_file_name="flight_data_t_plus_12",
    failed_routes_json_file_name="failed_routes_t_plus_12",
    no_data_routes_json_file_name="no_data_routes_t_plus_12.json",
